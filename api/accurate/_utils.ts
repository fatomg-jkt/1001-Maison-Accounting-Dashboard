...
import {canAccessNeracaAndLabaRugi,getSessionUser} from '../../src/lib/financial-access.js'
...
export function requireFinancialStatementsAccess(req:any,res:any){if(canAccessNeracaAndLabaRugi(getSessionUser(req),process.env.ADMIN_EMAILS))return true;send(res,403,{success:false,message:'Anda tidak memiliki akses ke halaman ini.'});return false}
