...
import {activeSession} from '../_lib/access.js'
...
export async function requireFinancialStatementsAccess(req:any,res:any){if(await activeSession(req))return true;send(res,401,{success:false,message:'Session tidak valid atau sudah kedaluwarsa.'});return false}
