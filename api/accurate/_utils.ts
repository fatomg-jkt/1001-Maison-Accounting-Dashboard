...
import {canAccessFinancialStatements,getSessionUser} from '../../src/lib/financial-access.js'
...
export function requireFinancialStatementsAccess(req:any,res:any){if(canAccessFinancialStatements(getSessionUser(req),process.env.OWNER_EMAIL))return true;send(res,403,{success:false,message:'Anda tidak memiliki akses ke halaman ini.'});return false}
