...
export function requireFinancialStatementsAccess(req:any,res:any){if(canAccessNeracaAndLabaRugi(getSessionUser(req)))return true;send(res,403,{success:false,message:'Anda tidak memiliki akses ke halaman ini.'});return false}
