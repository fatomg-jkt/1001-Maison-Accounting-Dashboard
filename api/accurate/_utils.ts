...
import {canAccessRestrictedFinancialReport,getValidatedSessionUser} from '../../src/lib/financial-access.js'
...
export function requireFinancialStatementsAccess(req:any,res:any){if(canAccessRestrictedFinancialReport(getValidatedSessionUser(req)))return true;send(res,403,{success:false,message:'Anda tidak memiliki akses ke halaman ini.'});return false}
