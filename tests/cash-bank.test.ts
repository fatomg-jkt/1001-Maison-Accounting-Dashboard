...
test('accepts the seven-column cash and bank template payload',()=>{
  const result=validateCashBankRows([{company:'CV. Sepuluh Januari Sukses',month:'Januari',year:2026,bankName:'BCA',currency:'idr',endingBalance:125000000,description:'Operasional'}])
